...
},{"corslite":3,"polyline":6}],8:[function(require,module,exports){
'use strict';
...
module.exports = function (container, directions) {
    ...
    directions.on('selectRoute', function (e) {
        ...
        steps.append('div')
            ...
            .text(function (step) { return step.distance ? format.metric(step.distance) : ''; });
